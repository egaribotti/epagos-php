...
namespace Handler\Epagos;

use Handler\Epagos\Exceptions\EpagosException;
use SoapClient;
use SoapFault;
...
class Epagos
{
    ...
    {
        $wsdl = json_decode(file_get_contents(
            dirname(__DIR__) . DIRECTORY_SEPARATOR . 'wsdl_soap.json'), true)[$entorno];
